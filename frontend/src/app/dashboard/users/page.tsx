    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-[13px] text-text-muted mt-1">{filteredUsers.length} registered user{filteredUsers.length !== 1 ? "s" : ""}</p>
        </div>
                ...
                {filteredUsers.length === 0 ? (
                  <tr>
                    <td colSpan={4} className="table-cell text-center py-12">
                      <p className="text-text-secondary text-sm">No users found matching &ldquo;{searchQuery}&rdquo;</p>
                    </td>
                  </tr>
                ) : (
